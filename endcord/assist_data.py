...
COMMAND_ASSISTS = (
    ...
    ("rename_folder [name] - locally rename selected folder in tree", "rename_folder"),
    ("toggle_pinned *<#[channel_id]> - toggle pinned state for selected channel in tree", "toggle_pinned"),
